# -*- coding: utf-8 -*-
"""
Arabidopsis XGBoost TE model for within- and cross-species comparison.
...
Run:
    python xgboost_ara_cross_species_comparable.py --file "C:/path/data.xlsx"
"""
...
RESULT_DIR = "xgboost_ara_cross_species_results"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Arabidopsis XGBoost model for cross-species comparison"
    )
...
def main():
    ...
    booster.save_model(os.path.join(args.result_dir, "xgboost_ara_model.json"))
